...
export default function BulkRemove({ auth, roles, users }) {
    ...
    return (
        <AdminLayout title="Bulk Remove Roles" auth={auth}>
            <Head title="Bulk Remove Roles" />

            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Bulk Remove Roles</h1>
                        <p className="text-gray-600">Remove specific roles from multiple users at once.</p>
                    </div>
                    <Link
                ...
                <form onSubmit={submit} className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6 flex flex-col h-[600px]">
                        <div className="mb-4">
                            <h2 className="text-lg font-semibold text-gray-900 mb-2">1. Select Roles to Remove</h2>
                            <input
                                type="text"
                    ...
                    <div className="bg-white rounded-xl shadow-sm p-6 flex flex-col h-[600px]">
                        <div className="mb-4">
                            <div className="flex justify-between items-center mb-2">
                                ...
                                <button type="button" onClick={selectAllUsers} className="text-sm text-red-600 hover:text-red-800">
                    ...
                    <div className="lg:col-span-2 flex justify-end">
                        <button
                            ...
                            className="bg-red-600 hover:bg-red-700 text-white px-8 py-3 rounded-lg font-semibold shadow-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {processing ? 'Removing...' : 'Remove Selected Roles from Selected Users'}
                        </button>
                    </div>
                </form>
            </div>
