...
export default function RolesCreate({ auth, routesByModule = {} }) {
    ...
    const handleSelectAllModule = (module, routes) => {
        ...
        setSelectedRoutes(updatedRoutes);
        setData('route_ids', updatedRoutes);
        setSelectAll({ ...selectAll, [module]: !allSelected });
    };
            ...
            <div className="space-y-6">
                <div className="flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-gray-600">Create a role with specific permissions for different system modules</p>
                    </div>
                    <Link
                ...
                <form onSubmit={submit} className="space-y-6">
                        ...
                        {Object.keys(filteredRoutesByModule).length === 0 ? (
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                {Object.entries(filteredRoutesByModule).map(([module, routes]) => {
                                    ...
                                    const isPartiallySelected = selectedCount > 0 && selectedCount < moduleRouteIds.length;
                    ...
                    <div className="flex justify-end gap-4 pt-6">
                        ...
                        >
                            ...
                            {processing ? 'Creating Role...' : `Create Role ${selectedRoutes.length > 0 ? `(${selectedRoutes.length} permissions)` : ''}`}
                        </button>
                    </div>
                </form>
            </div>
